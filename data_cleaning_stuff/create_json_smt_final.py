...
for each_idx, each in enumerate(dir_list):
    ...
    rdnn_f_path = os.path.join(dir_path, rdnn_fname)
    ...
    data_dict = {'input_image_rdnn': rdnn_f_path, 'input_image': pcnn_f_path, 'output_image_diff': smt_diff_f_path, 'output_image_trans': smt_trans_f_path, 'output_image_intra': smt_intra_f_path, 'mask': mask_path, 'vol_frac': volfrac_f_path}
