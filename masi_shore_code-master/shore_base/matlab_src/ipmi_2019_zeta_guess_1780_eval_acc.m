function ipmi_2019_zeta_guess_1780_eval_acc

    
    base_result_path = 'D:\Users\Vishwesh\PycharmProjects\shore_mapmri\ipmi_results\zeta_guess_1780\';
    ...
    figure
    subplot(2,2,1)
    hist(b6k_acc_vec,100)
    xlabel('Angular Correlation Coefficient')
    ylabel('Number of Voxels')
    title('B6000')
    subplot(2,2,2)
    hist(b3k_b6k_acc_vec,100)
    xlabel('Angular Correlation Coefficient')
    ylabel('Number of Voxels')
    title('B3000-B6000')
    subplot(2,2,3)
    hist(b3k_b6k_b9k_acc_vec,100)
    xlabel('Angular Correlation Coefficient')
    ylabel('Number of Voxels')
    title('B3000,B6000,B9000')
    subplot(2,2,4)
    hist(b3k_b6k_b9k_b12k_acc_vec,100)
    xlabel('Angular Correlation Coefficient')
    ylabel('Number of Voxels')
    title('B3000,B6000,B9000,B12000')
    
    median(b6k_acc_vec)
    median(b3k_b6k_acc_vec)
    median(b3k_b6k_b9k_acc_vec)
    median(b3k_b6k_b9k_b12k_acc_vec)
end