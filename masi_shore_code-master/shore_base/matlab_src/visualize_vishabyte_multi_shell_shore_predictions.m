function visualize_vishabyte_multi_shell_shore_predictions


    load('D:\Users\Vishwesh\PycharmProjects\shore_mapmri\dl_results\Shore_input_Shore_output_v1\Vishabyte_Preds\result.mat')
        ...
        for j = 1:dims(2)
            for k = 1:dims(3)
                if (mask(i,j,k) == 1)
                    ...
                    vish_q_space(i,j,k,:) = q_space_pred_row(2:end);
    ...
    'sh_coefs', ...    
    {10,60,true});
    dv_single.plot_slice(37,'axial','slice');
    axis image;
