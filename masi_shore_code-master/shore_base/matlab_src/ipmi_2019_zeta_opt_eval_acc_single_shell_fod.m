function [b6k_acc_vec,b3k_b6k_acc_vec,b3k_b6k_b9k_acc_vec,b3k_b6k_b9k_b12k_acc_vec] = ipmi_2019_zeta_opt_eval_acc_single_shell_fod
    
    base_result_path = 'D:\Users\Vishwesh\PycharmProjects\shore_mapmri\ipmi_results\zeta_optimized_fod_single_shell\';
    load('D:\Users\Vishwesh\PycharmProjects\shore_mapmri\fod_shore_single_shell_basis_r6.mat')
    ...
    %b6k_q_full_preds = zeros(length(out_matrix),401);
    
    b3k_b6k_q_preds = zeros(length(out_matrix),100);
    %b3k_b6k_q_full_preds = zeros(length(out_matrix),401);
    
    b3k_b6k_b9k_q_preds = zeros(length(out_matrix),100);
    %b3k_b6k_b9k_q_full_preds = zeros(length(out_matrix),401);
    
    b3k_b6k_b9k_b12k_q_preds = zeros(length(out_matrix),100);
    %b3k_b6k_b9k_b12k_q_full_preds = zeros(length(out_matrix),401);
    ...
    for i = 1:length(out_matrix)
        ...
        q_space_pred_row = fod_shore_basis * b6k_shore_row;
        b6k_q_preds(i,:) = q_space_pred_row(2:101);
        %b6k_q_full_preds(i,:) = q_space_pred_row;
        ...
        q_space_pred_row = fod_shore_basis * b3k_b6k_shore_row;
        b3k_b6k_q_preds(i,:) = q_space_pred_row(2:101);
        %b3k_b6k_q_full_preds(i,:) = q_space_pred_row;
        ...
        q_space_pred_row = fod_shore_basis * b3k_b6k_b9k_shore_row;
        b3k_b6k_b9k_q_preds(i,:) = q_space_pred_row(2:101);
        %b3k_b6k_b9k_q_full_preds(i,:) = q_space_pred_row;
        ...
        q_space_pred_row = fod_shore_basis * b3k_b6k_b9k_b12k_shore_row;
        b3k_b6k_b9k_b12k_q_preds(i,:) = q_space_pred_row(2:101);
        %b3k_b6k_b9k_b12k_q_full_preds(i,:) = q_space_pred_row;
    ...
    title_1 = sprintf('B6000, Median: %0.4f',b6k_med);
    title_2 = sprintf('B3000,B6000, Median: %0.4f',b3k_b6k_med);
    title_3 = sprintf('B3000,B6000,B9000 Median: %0.4f',b3k_b6k_b9k_med);
    title_4 = sprintf('B3000,B6000,B9000,B12000 Median: %0.4f',b3k_b6k_b9k_b12k_med);
