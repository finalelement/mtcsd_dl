function evaluate_shore_dl_predictions_with_shore_decayed_output
    ...
    %load('D:\Users\Vishwesh\PycharmProjects\shore_mapmri\dl_results\Shore_input_Shore_decayed_output_v6\Hist_Blind_72_Test\result.mat')
    %load('D:\Users\Vishwesh\PycharmProjects\shore_mapmri\shore_fod_decayed_basis_r6.mat')
    
    load('D:\Users\Vishwesh\PycharmProjects\shore_mapmri\dl_results\Shore_input_Shore_decayed_output_four_comb\Hist_Blind_72_Test\b6k_test_result.mat')
    load('D:\Users\Vishwesh\PycharmProjects\shore_mapmri\shore_fod_decayed_basis_r6.mat')
    ...
    q_full_preds = zeros(length(out_true),401);
    q_full_true = zeros(length(out_true),401);
    ...
    for i = 1:length(out_true)
        ...
        q_preds(i,:) = q_space_pred_row(2:101);
        q_full_preds(i,:) = q_space_pred_row;
        
        q_space_true_row = shore_basis * shore_t_row;
        q_true(i,:) = q_space_true_row(2:101);
        q_full_true(i,:) = q_space_true_row;
    ...
    title('4 Combinations of Shells As Training, B6K Test 72 Vox')
