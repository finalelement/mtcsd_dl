function [all_train,all_valid] = failed_sh_plots_ipmi_2019_acc

    base_path = 'D:\Users\Vishwesh\PycharmProjects\shore_mapmri\ipmi_results\failed_results_loop50_acc';
    ...
    for i = 3:length(base_path_dir_list)
        ...
        for j = 3:length(t_path_list)-1
            ...
            train_d(:,kfold_counter) = file_data(:,1);
            valid_d(:,kfold_counter) = file_data(:,4);
