function [b6k_acc_vec,b3k_b6k_acc_vec,b3k_b6k_b9k_acc_vec,b3k_b6k_b9k_b12k_acc_vec] = ipmi_2019_zeta_opt_eval_acc_log_single_shell_fod
    
    base_result_path = 'D:\Users\Vishwesh\PycharmProjects\shore_mapmri\ipmi_results\zeta_optimized_log_fod_single_shell\';
    load('D:\Users\Vishwesh\PycharmProjects\shore_mapmri\log_fod_shore_single_shell_basis_r6.mat')
    ...
    for i = 1:length(out_matrix)
        ...
        q_space_pred_row = log_fod_shore_basis * b6k_shore_row;
        b6k_q_preds(i,:) = exp(q_space_pred_row(2:101));
        ...
        q_space_pred_row = log_fod_shore_basis * b3k_b6k_shore_row;
        b3k_b6k_q_preds(i,:) = exp(q_space_pred_row(2:101));
        ...
        q_space_pred_row = log_fod_shore_basis * b3k_b6k_b9k_shore_row;
        b3k_b6k_b9k_q_preds(i,:) = exp(q_space_pred_row(2:101));
        ...
        q_space_pred_row = log_fod_shore_basis * b3k_b6k_b9k_b12k_shore_row;
        b3k_b6k_b9k_b12k_q_preds(i,:) = exp(q_space_pred_row(2:101));
