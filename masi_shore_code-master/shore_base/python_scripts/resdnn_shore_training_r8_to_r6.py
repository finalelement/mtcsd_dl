...
from deep_learning_models_training import build_base_network, build_base_resnet, build_base_resnet_r8_to_r6
from deep_learning_models_training import save_test_set_prediction, train_nn
# Base Deep Learning Path
dl_path = r'D:\Users\Vishwesh\PycharmProjects\shore_mapmri\miccai_results\zeta_optimized_fod_single_shell_r8_to_r6'

# Output Data FOD Paths
# fod_data_path = r'D:\Users\Vishwesh\PycharmProjects\shore_mapmri\shore_coeffs_decayed_fod_r6.mat'
fod_data_path = r'D:\Users\Vishwesh\PycharmProjects\shore_mapmri\Data\fod_shore_basis\fod_shore_coeffs_r6.mat'
...
for i in range(len(t_s_start_index)):
    ...
    model_D = build_base_resnet_r8_to_r6()
