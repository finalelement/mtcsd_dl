...
print('Fitting Log to Vishabyte Data')
vish_lambda = 0.005
log_nifti_img = nifti_img
log_nifti_img[log_nifti_img<0] = vish_lambda
t_log = np.log(log_nifti_img[:,:,:,1:])
log_nifti_img[:,:,:,1:] = t_log
...
savemat('log_vishabyte_shore_coeffs_r6.mat',mdict={'log_vish_shore': shore_input_matrix})
savemat('log_vishabyte_shore_reconst_r6.mat',mdict={'vish_reconst': signal_recon})